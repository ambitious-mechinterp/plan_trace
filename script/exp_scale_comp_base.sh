...
#SBATCH -o logs/scale_exp/base/slurm_auto_base.out
#SBATCH -e logs/scale_exp/base/slurm_auto_base.err
...
for PROMPT in "${PROMPTS[@]}"; do
  echo "Running prompt ${PROMPT} from selected file with base model (gemma-2-2b)"
  python -m plan_trace.pipeline ${PROMPT} \
    --model gemma-2-2b \
    --save \
    --output-dir outputs/scale-exp/base \
