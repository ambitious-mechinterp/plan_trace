...
if __name__ == "__main__":
    ...
    parser.add_argument("--step0-data-path", default=None, required=True)
    parser.add_argument("--save-data-path", default=None)
    args = parser.parse_args()

    if args.step0_data_path is None:
        raise ValueError("Please provide step0 data path using --step0-data-path argument.")
    ...
    phase1_data = load_json(args.step0_data_path)
